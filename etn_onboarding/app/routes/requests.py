...
def get_request(request_id):
    ...
    return jsonify({
        ...
        "lan_id": onboarding_req.lan_id,
        "first_name": onboarding_req.first_name,
        "last_name": onboarding_req.last_name,
        "requestor_name": onboarding_req.requestor_name,
        "requestor_email": onboarding_req.requestor_email,
        "team": onboarding_req.team,
        "app_emails": onboarding_req.app_emails,
        "environment": onboarding_req.environment,
        "workspace": onboarding_req.workspace,
        "worker_group": onboarding_req.worker_group,
        "region": onboarding_req.region,
        "data_type": onboarding_req.data_type,
        "log_destinations": onboarding_req.log_destinations,
        "log_types": onboarding_req.log_types,
        "ilm_tier": onboarding_req.ilm_tier,
        "entitlement_groups": onboarding_req.entitlement_groups,
        "pack_id": onboarding_req.pack_id,
        "pack_version": onboarding_req.pack_version,
